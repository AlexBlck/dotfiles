...
## Python
 ...
 - For python projects, use uv package manager
 - Organize dependencies in pyproject.toml to be used with `uv sync`
 - Adhere to OOP principles
 - Do typing wherever possigle, use modern typing from python 3.12
 - For CLI and argument parsing, use fire
 - Use Black code formatting style
 - If plotting something: prefer seaborn over matplotlib, use catppucin frappe color scheme:
...
# Load a style
mpl.style.use(["seaborn-v0_8", catppuccin.PALETTE.mocha.identifier])

# Load individual colors
color = load_color(catppuccin.PALETTE.mocha.identifier, "peach")
```
